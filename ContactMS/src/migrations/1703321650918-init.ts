...
export class Init1703321650918 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`address\` (\`id\` int NOT NULL AUTO_INCREMENT, \`province\` varchar(50) NOT NULL, \`city\` varchar(50) NOT NULL, \`district\` varchar(50) NOT NULL, \`details\` varchar(500) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
