...
export class Init1702552156784 implements MigrationInterface {
    name = 'Init1702552156784'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`product\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(50) NOT NULL, \`description\` varchar(5000) NULL, \`categoryId\` int NOT NULL, \`brandId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
